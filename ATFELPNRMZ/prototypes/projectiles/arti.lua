-- arti.lua
-- Артиллерийские снаряды ATF (кислотные и напалмовые)
-- Версия: 1.1 (Rebalance by Mechromancer-Zero)
-- Интеграция: Bob's Warfare Compatibility

extend({
    -- =========================================================================
    -- ATF-artillery-projectile-acid: Кислотный артиллерийский снаряд
    -- =========================================================================
    {
    ...
    -- =========================================================================
    -- ATF-artillery-projectile-napalm: Напалмовый артиллерийский снаряд
    -- =========================================================================
    {
        type ="artillery-projectile",
...
log("[ATF-Rebalance] Artillery projectiles loaded successfully (acid, napalm)")
...
if mods["bobwarfare"] then
    log("[ATF-Rebalance] Bob's Warfare detected - artillery projectiles compatible")
end