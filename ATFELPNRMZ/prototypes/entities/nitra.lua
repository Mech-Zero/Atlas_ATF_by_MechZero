...
data:extend({
    {
        ...
        stages = {
            sheet = {
                filename ="__Atlas_ATF__/graphics/ores/nitra.png",  -- ИСПРАВЛЕНО: было cinnabar.png
                priority ="extra-high",
                width = 64,
                height = 64,
                frame_count = 8,
                ...
                scale = 0.5,
                hr_version = {
                    filename ="__Atlas_ATF__/graphics/ores/hr-nitra.png",  -- ИСПРАВЛЕНО: было hr-cinnabar.png
                    priority ="extra-high",
                    width = 128,
                    height = 128,
                    frame_count = 8,
